...
describe('Shared: Errors', function() {
  ...
  describe('.getDescription()', function() {
    ...
    it('should get a generic description for EPERM', function() {
      const error = new Error('Foo');
      error.code = 'EPERM';
      m.chai.expect(errors.getDescription(error)).to.equal('Please ensure you have to necessary permissions for this task');
    });
    ...
    it('should get a generic description for ENOMEM', function() {
      const error = new Error('Foo');
      error.code = 'ENOMEM';
      m.chai.expect(errors.getDescription(error)).to.equal('Make sure your system has enough available memory for this task');
    });
